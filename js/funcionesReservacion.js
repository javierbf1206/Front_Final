...
function getReservaciones(){
    $.ajax({
        url:"http://192.9.128.172:8080/api/Reservation/all",
        type:"GET",
        datatype:"JSON",
...
function postReservaciones(){
    ...
    //console.log(cajas);
    $.ajax({
        url:"http://192.9.128.172:8080/api/Reservation/save",
        type:"POST",
        datatype:"JSON",
...
function getCliente_Reservaciones(){
    $.ajax({
        url:"http://192.9.128.172:8080/api/Client/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
...
function getRoom_Reservaciones(){
    $.ajax({
        url:"http://192.9.128.172:8080/api/Room/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
